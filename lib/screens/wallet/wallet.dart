                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    AppLocalizations.instance.text("loc_deposite"),
                                    style: CustomWidget(context: context)
                                        .CustomSizedTextStyle(
                                        12.0,
               ...
               child: Column(
                 ...
                 children: [
                   ...
                   Container(
                       ...
                       decoration: BoxDecoration(
                           border: Border.all(
                               color:allTicker.length > 0? Theme.of(context).splashColor:Theme.of(context).backgroundColor, width: 1.0),
                       ...
                       child:  allTicker.length > 0?ListView.builder(
                         ...
                         itemBuilder: (BuildContext context, int index) {
                           ...
                           String coinImage1 =
                           allTicker[index].pair!.split("-")[1].toString();
                           return Column(
                             children: [
                               Container(
                                 width: MediaQuery.of(context).size.width,
