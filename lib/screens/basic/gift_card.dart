...
class _GiftCard_DetailsState extends State<GiftCard_Details> {
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: SingleChildScrollView(
                        child: firstStage ? listWidget() : detailWidget(),
                      )),
                ],
              )),
        ),
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              AppLocalizations.instance.text("loc_add_cart"),
                              style: CustomWidget(context: context)
                                  .CustomSizedTextStyle(
                                      12.0,
  ...
  Widget detailWidget() {
    return Container(
        padding:
            EdgeInsets.only(top: 5.0, bottom: 5.0, right: 12.0, left: 12.0),
        decoration: BoxDecoration(
          color: Theme.of(context).focusColor,
