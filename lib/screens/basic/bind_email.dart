...
class Bind_Email_Screen extends StatefulWidget {
  const Bind_Email_Screen({Key? key}) : super(key: key);

  @override
  State<Bind_Email_Screen> createState() => _Bind_Email_ScreenState();
}

class _Bind_Email_ScreenState extends State<Bind_Email_Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          AppLocalizations.instance.text("loc_bind_email"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Lorem ipsum . Maecenas consectetur nulla at habitasse. Integer accumsan nulla adipiscing diam ut pellentesque. Diam arcu ornare turpis non non porttitor a et. Curabitur pellentesque.",
                style: CustomWidget(context: context)
                    .CustomSizedTextStyle(
                    10.0,
                    Theme.of(context).canvasColor,
