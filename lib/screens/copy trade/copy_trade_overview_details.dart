...
class CopyTradeOverviewDetails extends StatefulWidget {
  ...
  const CopyTradeOverviewDetails({Key? key, required this.data})
      : super(key: key);

  @override
  State<CopyTradeOverviewDetails> createState() =>
      _CopyTradeOverviewDetailsState();
}
...
class _CopyTradeOverviewDetailsState extends State<CopyTradeOverviewDetails>
  ...
  void initState() {
    ...
    final DateTime time1 = DateTime.parse(dfinals);
    dfinal = timeago.format(time1);
    getDetails();
  }
                      ...
                      Container(
                        child: Column(
                          ...
                          children: [
                            ...
                            //     Container(
                            //       padding:
                            //           EdgeInsets.fromLTRB(10.0, 5.0, 10.0, 7.0),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            copyData!.followCount.toString() +
                                " / " +
                                copyData!.maxFollowCount.toString(),
                            style: CustomWidget(context: context)
                                .CustomSizedTextStyle(
                                    14.0,
                                    Theme.of(context).primaryColor,
                  ...
                  Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                            children: copyData!.tradingPairsAvailable!
                                .asMap()
                                .map((index, listItem) => MapEntry(
                                    index,
                                    Container(
                                        ...
                                        child: Text(
                                          copyData!.tradingPairsAvailable![index]
                                              .toString(),
                                          style: CustomWidget(context: context)
                                              .CustomSizedTextStyle(
                                              10.0,
