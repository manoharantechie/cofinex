                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    child:  Container(
                                      ...
                                      child: Text(
                                        kycStatus.toString().toUpperCase()=="PENDING"?"UnVerified":"Verified",
                                        style: CustomWidget(context: context)
                                            .CustomSizedTextStyle(
                                            8.0,
                                            Theme.of(context).dialogBackgroundColor,
    ...
    apiUtils.getUserDetails().then((dynamic loginData) {
      setState(() {
        if (loginData["status"].toString() == "false") {
          ...
          //userID=datas.data!..toString();
          nameController.text=datas.data!.name.toString();
          referController.text=datas.data!.promoCode.toString();
          loading=false;
            kycStatus=datas.data!.kycStatus.toString();
            kycLink=datas.data!.kycCaptureLink.toString();
