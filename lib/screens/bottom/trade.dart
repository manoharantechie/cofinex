...
class _TradeScreenState extends State<TradeScreen>
  ...
  late TabController _tabController, _tabTradeController, _tabCrossController,_tabFiatController;
  bool collapse = false;
                                ...
                                children: [
                                  Flexible(
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color:
                                               !fiatOption? Theme.of(context).buttonColor:Theme.of(context).primaryColor,
                                            borderRadius:
                                                BorderRadius.circular(5.0)),
                                        padding: EdgeInsets.only(
                                            top: 7.0, bottom: 7.0),
                                          ...
                                          child: Text(
                                            ...
                                            style:
                                                CustomWidget(context: context)
                                                    .CustomSizedTextStyle(
                                                        10.0,
                                                    !fiatOption?CustomTheme.of(context)
                                                         .primaryColor:   CustomTheme.of(context)
                                                            .focusColor,
                                                        FontWeight.w600,
                                                        'FontRegular'),
                                          ),
                                  ...
                                  Flexible(
                                    ...
                                    child: Container(
                                      width: MediaQuery.of(context).size.width,
                                      decoration: BoxDecoration(
                                          color: fiatOption? Theme.of(context).buttonColor:Theme.of(context).primaryColor,
                                          borderRadius:
                                              BorderRadius.circular(5.0)),
                                      padding: EdgeInsets.only(
                                          top: 7.0, bottom: 7.0),
